...
group.IgM = nlme(IgM~b1+(b0-b1)*exp(-k1*DaysFromDays/360)-b1*k1*(exp(-k1*DaysFromDays/360)-exp(-k2*DaysFromDays/360)),
                 ...
                 na.action=na.pass,
                 correlation = corAR1(),
                 control=nlmeControl(maxIter=200,msMaxIter =100))
save(group.IgS, file = "model_genderIgM.rdata")
...
save(group.IgS, file = "model_genderIgG.rdata")
...
group.IgS = nlme(IgS~b1+(b0-b1)*exp(-k1*DaysFromDays/270)-b1*k1*(exp(-k1*DaysFromDays/270)),
                 ...
                 start=c(80,50,
                         ...
                         24,0),
                 na.action=na.pass,
                 control=nlmeControl(maxIter=200,msMaxIter =100, minScale = 0.00000001, pnlsTol = 0.1))
save(group.IgS, file = "model_genderIgGS.rdata")
